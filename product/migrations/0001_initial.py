        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description_arabic",
                    models.TextField(
                        max_length=1024, verbose_name="Arabic Description"
                    ),
                ),
                (
                    "description_english",
                    models.TextField(
                        max_length=1024, verbose_name="English Description"
                    ),
                ),
                (
                    "price",
                ...
                (
                    "detail_arabic",
                    models.TextField(max_length=512, verbose_name="Detail_Arabic"),
                ),
                (
                    "detail_english",
                    models.TextField(max_length=512, verbose_name="Detail_English"),
                ),
